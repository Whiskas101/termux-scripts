...
move_media(){
	...
	find "$MEGAPATH" -type f -print0 | egrep -z "\.(txt|mp4|mkv|mov|avi|webm|png|jpg|jpeg|webp)" | xargs -0 -I {} mv {} "$DEST/{}"

	#echo "Moving files from REDDIT..."
	#find "$REDDITPATH" -type f -print0 | egrep -z "*\.txt|*\.mp4| *\.mkv|*\.mov|*\.avi|*\.webm|*\.png|*\.jpg|*\.jpeg|*\.webp" | xargs -0 -I {} mv {} "$DEST/{}"

	#echo "Moving files from Downloads..."
	#find "$DWNLDPATH" -type f -print0 | egrep -z "*\.txt|*\.mp4| *\.mkv|*\.mov|*\.avi|*\.webm|*\.png|*\.jpg|*\.jpeg|*\.webp" | xargs -0 -I {} mv {} "$DEST/{}"
